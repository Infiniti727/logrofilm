...
(6, 494558, 'Shrek', 'Shrek', 'Hace mucho tiempo, en una lejanísima ciénaga, vivía un feroz ogro llamado Shrek. De repente, un día, su soledad se ve interrumpida por una invasión de sorprendentes personajes. Hay ratoncitos ciegos en su comida, un enorme y malísimo lobo en su cama, tres cerditos sin hogar y otros seres que han sido deportados de su tierra por el malvado Lord Farquaad. Para salvar su territorio, Shrek hace un pacto con Farquaad y emprende viaje para conseguir que la bella princesa Fiona acceda a ser la novia del Lord. En tan importante misión le acompaña un divertido burro, dispuesto a hacer cualquier cosa por Shrek: todo, menos guardar silencio.', 'http://localhost:5500/logrofilm/public/img/494558.png', 2001, 87, '', 'Andrew Adamson,Vicky Jenson', 'Animación,Comedia,Fantástico,Aventuras,Parodia,Cuentos,Fantasía medieval,Dragones', 0),
(7, 166270, 'Five Nights at Freddys', 'Five Nights at Freddys', 'Un hombre comienza un trabajo como guardia de seguridad nocturno en el restaurante Freddy Fazbears Pizza, donde descubre que los animatrónicos se mueven por la noche y matan a cualquiera que vean. Adaptación de la exitosa saga de videojuegos homónima creada en 2014 por Scott Cawthon.', 'http://localhost:5500/logrofilm/public/img/166270.png', 2023, 110, '', 'Emma Tammi', 'Terror,Fantástico,Muñecos,Monstruos,Videojuego', 0),
